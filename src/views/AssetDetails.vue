<template>
    <div class="asset_details_container flexColumn">
        <div class="asset_details_wrap">
            <div class="asset_details_title_container flexRow">
                <span class="asset_details_title">
                    {{ $route.query.type === 'check'? '资产信息' : '资产转让详情' }}
                </span>
                <div class="edit_btn_container flexRow">
            ...
            <div class="asset_details_upload_container flexRow"
                ...
                <div class="file_list_container flexColumn">
            ...
            <div class="asset_details_trans_container flexRow"
                 v-show="applyTransShow"
                 v-if="$route.query.type === 'trans'">
            ...
            <div class="content_container" style="margin-top:20px;">
                ...
                <div class="auth_refresh_btn flexRow" @click="refreshList('evi')">
                    <div class="latest_update_time_container flexRow">
            ...
            <div class="content_container" style="margin-top:20px;">
                ...
                <div class="content_chain_info_wrap flexRow">
            ...
            <div class="content_container">
                ...
                <div class="auth_refresh_btn flexRow" @click="refreshList('trans')">
                    <div class="latest_update_time_container flexRow" v-show="transLatestUpdateTime">
                        <span class="latest_update_title">
                            最后更新时间
                        </span>
                        <span class="latest_update_content">
            ...
            <div class="pagination_container flexRow" v-show="totalTransCount > 5">
            ...
            <div class="content_container">
                ...
                <div class="auth_refresh_btn flexRow" @click="refreshList('auth')">
                    <div class="latest_update_time_container flexRow" v-show="authLatestUpdateTime">
                        <span class="latest_update_title">
                            最后更新时间
                        </span>
                        <span class="latest_update_content">
            ...
            <div class="pagination_container flexRow" v-show="totalApplyCount > 5">
                <span class="total_page">
                    共{{ totalApplyCount }}条
                </span>
                <el-pagination
            ...
            <div class="content_container">
                ...
                <div class="auth_refresh_btn flexRow" @click="refreshList('check')">
                    <img src="../assets/refresh.png" class="refresh_icon">
                    <span class="auth_refresh_btn_refresh">
                        刷新
                    </span>
            ...
            <div class="pagination_container flexRow" v-show="totalcheckCount > 5">
                <span class="total_page">
                    共{{ totalcheckCount }}条
                </span>
                <el-pagination
            ...
            <div class="content_container">
                <div class="content_tab_container flexRow">
                ...
                <div class="auth_refresh_btn flexRow" @click="refreshList('list')">
                    <img src="../assets/refresh.png" class="refresh_icon">
                    <span class="auth_refresh_btn_refresh">
                        刷新
                    </span>
            ...
            <div class="pagination_container flexRow" v-show="totalTxListCount > 5 && tab === 0">
                    <span class="total_page">
            ...
            <div class="pagination_container flexRow" v-show="totalServiceListCount > 5 && tab === 1">
                    <span class="total_page">
            ...
            <div class="pagination_container flexRow" v-show="totalEvidenceListCount > 5 && tab === 2">
                    <span class="total_page">
        ...
        <el-dialog
            ...
            <div class="asset_details_dialog_container">
                ...
                <div class="asset_details_dialog_content_container flexRow"
                     @click="download(item)"
...
<script lang="ts">
      ...
      export default class AssetDetails extends Vue {
            ...
            private applyAndAuthDataList: any[] = [];
            private checkDataList: any[] = [];
            private assetListData: any[] = [];
            private serviceListData: any[] = [];
            private tab: number = 0;
            private totalTransCount: number = 1;
            private totalApplyCount: number = 1;
            private totalcheckCount: number = 1;
            private totalTxListCount: number = 1;
            private totalServiceListCount: number = 1;
            private totalEvidenceListCount: number = 0;
            private totalEvidenceDetailCount: number = 0;
            private value: string = '';
            private centerDialogVisible: boolean = false;
            private evidenceMaskVisible: boolean = false;
            private dialogTitle: string = '确认转让?';
            private dialogType: number = 1;
            private transCurrentPage: number = 1;
            private authCurrentPage: number = 1;
            private checkCurrentPage: number = 1;
            private assetTxCurrentPage: number = 1;
            private serviceTxCurrentPage: number = 1;
            private evidenceTxCurrentPage: number = 1;
            private hasSecret: boolean = true;
            private accountApplyAuthorizeStatus: number = 5;
            private accountApplyTransStatus: number = 5;
            private operateNftId: number = 0;
            private requestId: number = 0;
            private consumer: string = '';
            private authRequestId: string = '';
            private flUnlock: boolean = false;
            private nftId: string = '';
            private provider: string = '';//转让的时候需要
            private flMounted: boolean = false;
            private useUnlock: boolean = false;
            private loading: boolean = false;
            private applyBtnLoading: boolean = false;
            private transRequestId: string = '';
            private postTransRequestId: string = '';
            private postTransNftId: string = '';
            ...
            private isDecrypto: boolean = false;
            private evidenceLoading: boolean = true;
            private transLoading: boolean = true;
            private applyLoading: boolean = true;
            private checkLoading: boolean = true;
            ...
            private beforeMount(): void {
                  ...
                  if (token) {
                        for (const key of Object.keys(config.account)) {
                              this.options.push({
                                    value: config.account[key].address,
                                    label: config.account[key].name,
                                    disabled: config.account[key].address === JSON.parse(token).address
                              })
                        }
                  }
            ...
            private get replaceAuthorizationDataToStar(): boolean {
                  //判断授权查看数据是否展示***
            ...
            private uploadFile(): void {
                  const fileNode: any = document.getElementById('upload_file');
                  if (fileNode) {
                        fileNode.click();
                  }
            }
            ...
            private handleFileClick(file: any): void {
            ...
            private acceptTrans(row: any): void {
                  this.centerDialogVisible = true;
            ...
            private handleAuthClick(row: any): void {
                  this.centerDialogVisible = true;
            ...
            private handleRefusedClick(row: any): void {
                  this.centerDialogVisible = true;
            ...
            private transRefused(row: any): void {
                  this.centerDialogVisible = true;
            ...
            private onTxTransPaginationClick(page: number): void {
                  this.transCurrentPage = page;
                  this.getAssetTransList(page);
            }

            private onAuthPaginationClick(page: number): void {
                  this.authCurrentPage = page;
                  this.getAssetAuthList(page);
            }

            private onCheckPaginationClick(page: number): void {
                  this.checkCurrentPage = page;
                  this.getCheckStatus(page);
            }

            private onAssetTxPaginationClick(page: number): void {
                  this.assetTxCurrentPage = page;
                  this.getAssetTxList(page);
            }

            private onServiceTxPaginationClick(page: number): void {
                  this.serviceTxCurrentPage = page;
                  this.getServiceDataList(page);
            }

            private onEvidenceTxPaginationClick(page: number): void {
            ...
            private unlock(): void {//点击解密
                  ...
                  axios.post({
                        ...
                        if (data && data.data && data.data.status === 'success') {
                              ...
                              const el: any = document.getElementById('detail_json_schema_node');
            ...
            private getCheckElement(tag: string, dataAttr: string, reg?: any): any[] {
                  const node: any = document.getElementById('schema_container');
                  if (node) {
                        const aElements: any = node.getElementsByTagName(tag);
                        let aEle = [];

                        for (let e of aElements) {
                              const ele: string | undefined = e.getAttribute(dataAttr);
                              if (ele && typeof ele === 'string' && ele.startsWith('/') && ele !== '/') {
                                    aEle.push(e);
                              }
                        }
            ...
            private getElementByAttr(tag: string, dataAttr: string): any[] {
                  const node: any = document.getElementById('schema_container');
                  let aElements: any;
                  let aEle: any[] = [];
                  if (node) {
                        aElements = node.getElementsByTagName(tag);
                        for (let i = 0; i < aElements.length; i++) {
                              let ele = aElements[i].getAttribute(dataAttr);
            ...
            private setSecretFieldStyle(showSecret?: boolean): void{
                  setTimeout(() => {
                        ...
                        this.authorizationList.forEach((a: string) => {
                              let replaced: string = a.replace(/\./g, '/').replace('$', '');
                              if (pathMap.has(replaced)) {
                                    ...
                                    Array.from(pathMap.keys()).forEach((p: string) => {
                        ...
                        this.secretList.forEach((a: string) => {
                              let replaced: string = a.replace(/\./g, '/').replace('$', '');
                              if (pathMap.has(replaced)) {
            ...
            private drawNoteNode(): void {//添加密文注释
                  setTimeout(() => {
                        const node: any = this.getElementByAttr('div', 'data-alpaca-container-item-name');
                        if (node && node.length) {
